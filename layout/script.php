...
$header = '<header class="main-header">
    ...
    <a href="' . $url . '" class="logo">
      ...
      <span class="logo-mini"><b>C</b>EV</span>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      ...
                      <p>O natal chegou e a aprovação também</p>
                    </a>
                  </li>
                  <!-- end message -->
                  <li>
                  ...
                  <li>
                    <a href="#">
                      ...
                      <p>A venda de natal foi feita</p>
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      ...
                      <p>A aprovação foi concluida</p>
                    </a>
                  </li>
                </ul>
              </li>
              <li class="footer"><a href="#">Veja todas mensagens</a></li>
            </ul>
          </li>
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  <li>
                    <a href="#">
                      <i class="fa fa-users text-aqua"></i> 5 novas contas criadas.
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fa fa-warning text-yellow"></i> Entegas
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fa fa-users text-red"></i> 5 novas contas criadas.
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fa fa-shopping-cart text-green"></i> 25 vendas feitas
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fa fa-user text-red"></i> Você mudou o seu nome.
                    </a>
                  </li>
                </ul>
              </li>
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li><!-- Task item -->
                    <a href="#">
                      <h3>
                        Algumas tarefas que eu tenho que fazer
...
$header .= ' <small>Membro desde NOV. 2023</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
...
$footer = '<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="http://almsaeedstudio.com">Almsaeed Studio Free Bootstrap pages</a>.</strong> 
  </footer>
